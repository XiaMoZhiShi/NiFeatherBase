...
execute if score @s nife_position_delta matches ..-1 run function nifeather:events/player/teleport/abs_x
...
execute if score @s nife_position_delta matches ..-1 run function nifeather:events/player/teleport/abs_z
execute if score @s nife_position_delta >= trigger nife_position_delta run tag @s add shouldTriggerTP
